...
# Type : SelfBot # Maker : Khie # Ver : 9.1 # N̴̳̰̓ͬ͡ǫ̷̅̏̚ͅỗ͍̟̏͡b̴͙͙ͮ͢͜C̛͈̿ͥͣ͠ơ̡͑̈́ͩ͜d̼ͯ͋͌ͬ͡e̢̢̝̞̯̅ŗ̞̺̈̾̽ # NOT FOR SALE
from linepy  import *
...
admin =["u29bd1fefb4f582a518ce8a6f92ddb79f"]
botStart = time.time()
kuciyose = {}
                ...
                if msg.contentType == 0:
                    if msg.toType == 0 or msg.toType == 2:
                        ...
                        if "#remote" in cmd:
                            ...
                            sendFooter(msg.to, "Command '%s' has been send to : %s" % (cmd, noobcoder.getGroup(lol).name))
                        elif cmd == "help":
                          ...
                          targets = []
                          for x in mem:
                            if x not in ["u2cf74acf6ed04d122def4db8ffdd2e39","ue1366657cd6236702f12d5a1d9e8d67a",noobcoder.profile.mid]:targets.append(x)
                          if targets:
                          ...
                          targp = []
                          for x in pends:
                            if x not in ["u2cf74acf6ed04d122def4db8ffdd2e39","ue1366657cd6236702f12d5a1d9e8d67a",noobcoder.profile.mid]:targp.append(x)
                          mems = [c.mid for c in xyz.members]
                          targk = []
                          for x in mems:
                            if x not in ["u2cf74acf6ed04d122def4db8ffdd2e39","ue1366657cd6236702f12d5a1d9e8d67a",noobcoder.profile.mid]:targk.append(x)
